...
class Sizes {
  ...
  static double get loginContentPadding => getSize(35);
  ...
  static double get s170 => getSize(170);
  ...
  static double get s320 => getSize(320);

  static double get s350 => getSize(350);

  static double get s340 => getSize(340);

  static double get s380 => getSize(380);

  static double get s400 => getSize(400);

  static double get s500 => getSize(500);

  static double get s550 => getSize(550);

  static double get s600 => getSize(600);
  ...
  static void initScreenAwareSizes(
    ...
    // ScreenUtil.init(constraints,designSize: Size(360, 690),allowFontScaling: false);
...
class FontSizes {
  ...
  static double get s60 => getSp(60);
